    ...
    return {
        warp: {
            register: {
                ...
                admin: {InsecureOwner: "0xb56Dbc4650fcaC1A54Ff5feB31916DF015C7be6F"} as AdminClass,
                ism: {
                    MessageIdMultisig: { 
                        threshold: 1, // DEPLOYMENT: Replace with mainnet validator config
...
const setRelayerConfig: RuntimeCall = {
    interchain_gas_paymaster: {
        set_relayer_config: {
            beneficiary: "0xb56Dbc4650fcaC1A54Ff5feB31916DF015C7be6F",
...
const ethtestTokenId = readWarpRouteConfig(); // DEPLOYMENT: replace with mainnet token id
const createWarpRoute = buildCreateWarpRouteCall(ETHTEST_DOMAIN, ethtestTokenId); // DEPLOYMENT: replace with mainnet domain
